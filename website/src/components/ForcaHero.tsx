    ...
    <section className="relative py-12 md:py-20 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          <div className="z-10">
            <h1 className="text-[1.5rem] sm:text-[2.25rem] md:text-[3rem] lg:text-[3.25rem] font-extrabold leading-[1.1] tracking-tight text-foreground mb-5 max-w-xs sm:max-w-md lg:max-w-lg">
              Automatic focus mode for people who actually want to get work<span className="whitespace-nowrap"> <span className="text-accent italic">done</span></span>.
            </h1>
            ...
            <div className="flex flex-wrap items-center gap-3 mb-4">
                ...
                return (
                  <a
                    ...
                    className={`inline-flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-semibold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-background ${
                      p.id === platform
                        ? 'bg-accent text-white shadow-lg shadow-emerald-600/20 hover:bg-accent-hover hover:-translate-y-0.5'
              ...
              <a
                ...
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl border border-border text-muted-foreground hover:text-foreground hover:bg-muted text-sm font-semibold transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent focus-visible:ring-offset-2 focus-visible:ring-offset-background"
              >
            ...
            <div className="relative grid grid-cols-2 gap-3">
              {steps.map((step, i) => {
                ...
                return (
                  ...
                  >
                    {i === 0 && (
                      <div className="hidden lg:block absolute -right-[13px] top-1/2 -translate-y-1/2 z-10 text-indicator">
                    ...
                    {i === 1 && (
                      <div className="hidden lg:block absolute -bottom-[13px] left-1/2 -translate-x-1/2 z-10 text-indicator rotate-90">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                          <line x1="5" y1="12" x2="19" y2="12" />
                          <polyline points="12 5 19 12 12 19" />
                        </svg>
                    ...
                    {i === 2 && (
                      <div className="hidden lg:block absolute -left-[13px] top-1/2 -translate-y-1/2 z-10 text-indicator -scale-x-100">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                          <line x1="5" y1="12" x2="19" y2="12" />
                          <polyline points="12 5 19 12 12 19" />
                        </svg>
                    ...
                    <div className={`mt-3 h-0.5 rounded-full transition-all duration-500 ${
                      isActive ? 'bg-accent w-full' : 'bg-muted w-0'
                    }`} />
                  </motion.div>
                );
              })}
              ...
              {steps.map((_, i) => (
                <button
                  ...
                  className={`h-1.5 rounded-full transition-all duration-300 ${
                    i === activeStep ? 'bg-accent w-6' : 'bg-indicator w-1.5 hover:bg-indicator'
                  }`}
                  aria-label={`Step ${i + 1}`}
                />
              ))}
