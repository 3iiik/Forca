          ...
          {features.map((f, i) => {
            ...
            return (
              <motion.div
                ...
                className="rounded-2xl border border-border bg-gradient-to-b from-surface-top to-surface-bottom p-5 md:p-6 transition-transform duration-300 hover:-translate-y-1 hover:border-emerald-500/50 hover:shadow-lg hover:shadow-emerald-600/10"
