    ...
    content: (
      <div className="divide-y divide-[#27272a]">
        {[
          ...
          { q: 'Does it work on macOS or Linux?', a: <>Forca is now available on Windows, macOS, <em className="text-foreground">and</em> Linux. The browser extension works on all platforms. Download the latest version for your OS from the             <a href={import.meta.env.BASE_URL + 'download/'} className="text-accent hover:text-accent-hover underline underline-offset-2">download page</a>.</> },
          ...
          { q: 'How do I update Forca?', a: <>Forca checks for updates automatically on startup. When an update is available, you&apos;ll be prompted to download and install it. You can also download the latest version from the             <a href={import.meta.env.BASE_URL + 'download/'} className="text-accent hover:text-accent-hover underline underline-offset-2">download page</a>.</> },
          { q: 'Is my data private?', a: <>Yes. All data is stored locally on your computer. No data is sent to any server. Forca is open source, so you can verify this yourself. See our             <a href={import.meta.env.BASE_URL + 'privacy/'} className="text-accent hover:text-accent-hover underline underline-offset-2">privacy page</a> for details.</> },
