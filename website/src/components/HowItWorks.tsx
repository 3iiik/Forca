...
function StepCard({ step, index }: { step: (typeof steps)[0]; index: number }) {
  ...
  return (
    <motion.div
      ...
      className="relative flex flex-col items-center text-center rounded-2xl border border-border bg-gradient-to-b from-surface-top to-surface-bottom p-6 md:p-7 transition-transform duration-300 hover:-translate-y-1 hover:border-emerald-500/50 hover:shadow-lg hover:shadow-emerald-600/10"
